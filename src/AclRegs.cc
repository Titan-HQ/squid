...
ACL::Prototype ACLTitanApp::RegistryProtoype(&ACLTitanApp::RegistryEntry_, "titan_cmd");
ACLTitanApp ACLTitanApp::RegistryEntry_("titan_cmd");
ACL::Prototype ACLTitanCloud::RegistryProtoype(&ACLTitanCloud::RegistryEntry_, "titan_cloud");
ACLTitanCloud ACLTitanCloud::RegistryEntry_("titan_cloud");
#if USE_AUTH
...
ACL::Prototype ACLTitanAuth::UserRegistryProtoype(&ACLTitanAuth::UserRegistryEntry_, "titan_auth");
ACLTitanAuth ACLTitanAuth::UserRegistryEntry_(new ACLUserData, "titan_auth");
ACL::Prototype ACLTitanAuth::RegexRegistryProtoype(&ACLTitanAuth::RegexRegistryEntry_, "titan_auth_regex" );
ACLTitanAuth ACLTitanAuth::RegexRegistryEntry_(new ACLRegexData, "titan_auth_regex");
