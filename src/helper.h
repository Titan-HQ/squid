...
/* helper.c */
void helperOpenServers(helper * const hlp);
void helperStatefulOpenServers(statefulhelper * const hlp);
void helperSubmit(helper *const hlp, const char *const buf, HLPCB * const callback, void *const data);
void helperStatefulSubmit(statefulhelper * const hlp, const char * const buf, HLPCB * const callback, void *const data, helper_stateful_server * const lastserver);
void helperStats(StoreEntry * const sentry, helper * const hlp, const char *const label = NULL);
void helperStatefulStats(StoreEntry * const sentry, statefulhelper * const hlp, const char *const label = NULL);
void helperShutdown(helper * const hlp);
void helperStatefulShutdown(statefulhelper * const hlp);
void helperStatefulReleaseServer(helper_stateful_server * const  srv);
void *helperStatefulServerGetData(const helper_stateful_server * const srv);
